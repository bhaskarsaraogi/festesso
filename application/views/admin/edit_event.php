...
<section>
  ...
  <div class="well well-large">
    <h2>Event Details</h2>
    <?php
    echo form_open('admin/edit_event/'.$event_id, array('class' => 'form-horizontal'));
    ?>
      ...
      <div class="controls">
        <div class="input-prepend">
          ...
          $arr_user_name = array(
            ...
            'value'         => set_value('event_desp', $event_desp)
            );
      ...
      <div class="controls">
        <div class="input-prepend">
          ...
          $arr_user_name = array(
            ...
            'value'         => set_value('min_part', $min_part)
            );
          echo form_input($arr_user_name);
          ?>
        </div>
      ...
      <div class="controls">
        <div class="input-prepend">
          ...
          $arr_user_name = array(
            ...
            'value'         => set_value('max_part', $max_part)
            );
          echo form_input($arr_user_name);
          ?>
        </div>
